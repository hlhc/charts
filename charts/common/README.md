# HLHC Common Library Chart

A [Helm Library Chart](https://helm.sh/docs/topics/library_charts/#helm) for grouping common logic between hlhc charts.
...
dependencies:
  - name: common
    version: 2.x.x
    repository: oci://ghcr.io/hlhc/charts
```
